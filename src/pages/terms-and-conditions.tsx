  ...
  return (
    <Layout seo={seo}>
      <div className="m-auto my-12 max-w-3xl">
        <div className="prose-base prose-invert ">
          <div className="text-center">
            <h1>Terms And Conditions</h1>
            <p className="">Last Updated: June 26th, 2022</p>
          </div>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Pratik Badhe&apos;s Website, located at
            https://pratikbadhe.com/.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Pratik Badhe if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing Pratik Badhe, you agreed
            to use cookies in agreement with the Pratik Badhe&apos;s Privacy
            Policy.{' '}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Pratik Badhe and/or its licensors own the
            intellectual property rights for all material on Pratik Badhe. All
            intellectual property rights are reserved. You may access this from
            Pratik Badhe for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Pratik Badhe</li>
            <li>Sell, rent or sub-license material from Pratik Badhe</li>
            <li>Reproduce, duplicate or copy material from Pratik Badhe</li>
            <li>Redistribute content from Pratik Badhe</li>
          </ul>
          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            Pratik Badhe does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Pratik Badhe,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Pratik
            Badhe shall not be liable for the Comments or for any liability,
          ...
          <p>
            Pratik Badhe reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Pratik Badhe a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Pratik Badhe;
          ...
          <p>
            ...
            sending an e-mail to Pratik Badhe. Please include your name, your
          ...
          <p>
            No use of Pratik Badhe&apos;s logo or other artwork will be allowed
